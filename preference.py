...
class Ui_SettingDialog(object):
    ...
    def setupUi(self):
        ...
        self.horizontalLayout2 = self.horizontalLayout = QtWidgets.QHBoxLayout(
            self.widget)
        self.horizontalLayout2.setObjectName("horizontalLayout2")
        self.setmenuwidget = QtWidgets.QWidget(self.widget)
        self.setmenuwidget.setObjectName(
            "setmenuwidget")  #主体部分，构成除去几个按钮以外的整个上半部分
        ...
        self.verticalLayout3 = self.horizontalLayout = QtWidgets.QVBoxLayout(
            self.coreframe)
    ...
    def showsettings(self, menunum):
        ...
        self.menulabels[menunum].setStyleSheet(
        ...
        if menunum == 0:  #0：玩家设置 1：游戏设置 2：计数器设置
            ...
            self.horizontalLayout3 = self.horizontalLayout = QtWidgets.QHBoxLayout(
                self.coreframe2)
